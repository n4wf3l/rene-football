...
class AdminPlayerController extends Controller
{
    ...
    private function validateData(Request $request, ?Player $player = null): array
    {
        ...
        $rules = [
            ...
            'secondary_nationality' => ['nullable', 'string', 'max:120'],
            'languages_spoken'   => ['nullable', 'array', 'max:6'],
            'languages_spoken.*' => ['string', 'max:40'],
            'preferred_foot' => ['nullable', 'string', 'max:20'],
            'playing_style' => ['nullable', 'string', 'max:160'],
            'best_position' => ['nullable', 'string', 'max:120'],
            'objective'     => ['nullable', 'string', 'max:400'],
            'mental_strengths'   => ['nullable', 'array', 'max:8'],
            'mental_strengths.*' => ['string', 'max:60'],
            ...
            'gallery_photos.*' => ['string', 'max:500'],
            'career_history'          => ['nullable', 'array', 'max:12'],
            'career_history.*'        => ['array'],
            'career_history.*.years'  => ['nullable', 'string', 'max:40'],
            'career_history.*.club'   => ['nullable', 'string', 'max:120'],
            'career_history.*.logo_url' => ['nullable', 'string', 'max:500'],
            'previous_club'      => ['nullable', 'string', 'max:120'],
            'previous_club_logo' => ['nullable', 'string', 'max:500'],
