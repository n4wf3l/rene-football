...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var bool
         */
        // Presentations embed remote QR codes (qrserver.com) and previous-club
        // logos hosted on external CDNs. Also lets external cover / photo URLs
        // work when the admin pastes them rather than uploading.
        'enable_remote' => true,
