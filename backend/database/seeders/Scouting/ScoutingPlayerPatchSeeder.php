...
class ScoutingPlayerPatchSeeder extends Seeder
{
    public function run(): void
    {
        $patches = [
            ...
            // Hamzath - profil "world class 10/10" sur sa carte FutureBallers,
            // donc on monte volontairement les scores potentiel / confiance.
            'hamzath-mohamadou' => ['scouting_status' => 'shortlist_a', 'score_current' => 70, 'score_potential' => 99, 'score_club_fit' => 82, 'score_market' => 78, 'score_risk' => 22, 'score_confidence' => 78, 'next_action' => 'Suivi rapproché U-17 + entretien représentation long terme', 'source_label' => 'Borussia Dortmund - centre de formation U-17', 'reliability_score' => 82, 'scout_summary' => 'Ailier gauche U-15 allemand au BVB. 17 contributions décisives en U-17 à 15 ans. 1v1 hors-norme - comparable à Dembélé / Barcola. Potentiel évalué 10/10 (FutureBallers DE).'],
        ];
