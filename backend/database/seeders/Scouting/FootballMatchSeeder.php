...
class FootballMatchSeeder extends Seeder
{
    public function run(): void
    {
        $matches = [
            ...
            ['kickoff_at' => Carbon::now()->addDays(2)->setTime(20, 0), 'competition' => 'Eredivisie',  'season' => '2025-2026', 'home_team' => 'FC Twente',         'away_team' => 'AZ Alkmaar',        'category' => 'Pro', 'venue' => 'De Grolsch Veste, Enschede',  'status' => 'scheduled', 'notes' => 'Idriss N\'Diaye à observer en pointe.'],
            ['kickoff_at' => Carbon::now()->addDays(5)->setTime(15, 0), 'competition' => 'UEFA Youth',  'season' => '2025-2026', 'home_team' => 'Borussia Dortmund', 'away_team' => 'AC Milan U19',      'category' => 'U19', 'venue' => 'BVB Trainingszentrum',        'status' => 'scheduled', 'notes' => 'Mission scout junior - observer Hamzath Mohamadou.'],
        ];
